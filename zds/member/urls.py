...
urlpatterns = patterns('',
                       ...
                       url(r'^connexion/$',
                           'zds.member.views.login_view', name="login"),
                       url(r'^deconnexion/$',
                           'zds.member.views.logout_view', name="logout"),
                       url(r'^inscription/$',
                           'zds.member.views.register_view', name="register"),
                       url(r'^reinitialisation/$',
                           'zds.member.views.forgot_password', name="forgot_password"),
                       url(r'^new_password/$',
